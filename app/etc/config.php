...
return [
    ...
    'themes' => [
        ...
        'frontend/RTech/neo' => [
            'parent_id' => 'Magento/blank',
            'theme_path' => 'RTech/neo',
            'theme_title' => 'RTech Neo',
            'is_featured' => '0',
            'area' => 'frontend',
            'type' => '0',
            'code' => 'RTech/neo',
     ...
     * CONFIG__DEFAULT__MSP_SECURITYSUITE_RECAPTCHA__GENERAL__PUBLIC_KEY for msp_securitysuite_recaptcha/general/public_key
     * CONFIG__DEFAULT__MSP_SECURITYSUITE_RECAPTCHA__GENERAL__PRIVATE_KEY for msp_securitysuite_recaptcha/general/private_key
    ...
    'system' => [
        'default' => [
            'design' => [
                ...
                'head' => [
                    'default_title' => 'Romatech Commerce',
...
Disallow: /*SID=
                ...
                'footer' => [
                    'copyright' => 'Copyright © 2019 Roma Technology Ltd',
            ...
            'general' => [
                ...
                'region' => [
                    'display_all' => '1',
                    'state_required' => 'BR,CA,HR,EE,IN,LV,LT,RO,ES,CH,US',
                ],
                'store_information' => [
                    'name' => 'Romatech',
                    'phone' => '08458 673650',
                    ...
                    'city' => 'Newmarket',
                    'street_line1' => '24',
                    'street_line2' => 'High Street, Stetchworth',
                    'merchant_vat_number' => '287 2568 58',
                ],
            ],
            'theme' => [
                'customization' => [
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'msp_securitysuite_twofactorauth' => [
                ...
                'duo' => [
                    'application_key' => 'TscTpBZINP7blLxQ9ib3FgQ3LKBN9x7eLHnopugjBJPy3xKnlzJ08Zv3mmXWUYA2',
                ],
            ],
            'contact' => [
                'contact' => [
            ...
            'connector_dynamic_content' => [
                ...
                'external_dynamic_content_urls' => [
                    'passcode' => 'X9DGD2i8gVik7kMYrPOPlxFO5iTZwJma',
            ...
            'contentful' => [
                'general' => [
                    'access_token' => 'eb9b86cbc1e5d0a4e846eac796abbc62b21b1f740b7f2dc7e48bb03569f9b4a3',
                    'space_id' => 'vj0f9iibytzf',
                ],
                'footer' => [
                    'footer_id' => 'CdJADijiLbtHaqzux22DJ',
                ],
            ],
        ],
        'stores' => [
